    ...
    <section className="relative overflow-hidden py-20 md:py-32">
      ...
      <div className="container relative mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16 max-w-3xl mx-auto">
          <StatBox value={formatNumber(stats.quests)} label="Quests" color="#fde047" />
          <StatBox value={formatNumber(stats.users)} label="Warriors" color="#22c55e" />
          <StatBox value={formatNumber(stats.submissions)} label="Submissions" color="#f97316" />
          <StatBox value={formatNumber(stats.achievements)} label="Achievements" color="#ef4444" />
        </div>
      </div>
    </section>
  )
